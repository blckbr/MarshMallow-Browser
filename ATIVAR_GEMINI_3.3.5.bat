...
cd /d "%~dp0"
title MarshMallow 3.3.5 - Ativar Gemini

set "MMURL=https://marshmallow-gateway.marshmallow-browser-br.workers.dev"

echo.
echo ==============================================================
echo   MARSHMALLOW 3.3.5 - GEMINI COMO IA PRINCIPAL
echo ==============================================================
echo.
echo CORRECAO 3.3.5:
...
echo.
echo [1/4] Publicando primeiro o codigo 3.3.5...
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0scripts\validate-backend-3.3.5.ps1" -BaseUrl "%MMURL%" -RequireGemini -WaitSeconds 90
