(() => {
  const TRACKED_DOWNLOAD_URL = 'https://marshmallow-gateway.marshmallow-browser-br.workers.dev/download/windows';
  ...
  button.addEventListener('click', async () => {
    ...
    try {
      if ((release.mode === 'direct' || release.mode === 'tracked-direct') && release.url) {
        window.location.href = TRACKED_DOWNLOAD_URL;
        return;
      }
