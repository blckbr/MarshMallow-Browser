...
cd /d "%~dp0"
title MarshMallow 3.1.2 - Publicar Backend + IA + Contas

echo.
echo ==============================================================
echo   MARSHMALLOW 3.1.2 - BACKEND + WORKERS AI + CONTAS
echo ==============================================================
echo.
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$code=$LASTEXITCODE;" ^
  "$lines ^| Tee-Object -FilePath '..\MARSHMALLOW_3.1.2_DEPLOY.log' ^| ForEach-Object { Write-Host $_ };" ^
...
echo Consulte MARSHMALLOW_3.1.2_DEPLOY.log se ele tiver sido criado.
pause
exit /b 1
