...
setlocal
chcp 65001 >nul
title MarshMallow 5.0.0 - Smoke test

for %%I in ("%~dp0.") do set "ROOT=%%~fI"
set "PS1=%~dp0scripts\windows-smoke-5.0.ps1"
if exist "%PS1%" goto :helper_found
set "PS1=%~dp0windows-smoke-5.0.ps1"
if exist "%PS1%" (
  for %%I in ("%~dp0..") do set "ROOT=%%~fI"
  goto :helper_found
)

echo [PACOTE_5_COMPLETO] O script windows-smoke-5.0.ps1 nao foi encontrado.
