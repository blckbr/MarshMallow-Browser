...
do {
  try {
    ...
    $versionOk = ([string]$health.backendVersion -eq '3.3.4')
...
if ([string]$health.backendVersion -ne '3.3.4') { throw "Backend publicado ainda e $($health.backendVersion), esperado 3.3.4." }
