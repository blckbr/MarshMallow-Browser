...
const siteRoot = 'MarshMallow-Official-Website-5.0.0/site';
if (exists(siteRoot)) {
  ...
  if (exists(versionPath)) {
    ...
    expect(siteVersion.version === VERSION, 'site version.json matches 5.0.0');
  }
  ...
  if (exists(releasePath)) {
    ...
    expect(meta.version === VERSION, 'site release metadata version matches 5.0.0');
