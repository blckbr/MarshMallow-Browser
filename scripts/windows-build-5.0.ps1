...
$Version = '5.0.0'
$Log = Join-Path $Root 'BUILD_VALIDATION_5.0.0.log'
$Report = Join-Path $Root 'BUILD_VALIDATION_5.0.0.json'
...
try {
  ...
  Log "SHA256: $hash"
  Log 'RESULTADO: PASS - build automatizado concluido. Execute REGISTRAR_SMOKE_5.0.0.bat antes de publicar.'
  exit 0
} catch {
